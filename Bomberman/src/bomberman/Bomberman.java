...
public class Bomberman {
	...
	public void run() {
		...
		Engine.getInstancia().addTexturas("p1n", new Textura("assets/graficos/bomberman1/personaje/2/norte.png"));
		Engine.getInstancia().addTexturas("p1s", new Textura("assets/graficos/bomberman1/personaje/2/sur.png"));
		Engine.getInstancia().addTexturas("p1e", new Textura("assets/graficos/bomberman1/personaje/2/este.png"));
		Engine.getInstancia().addTexturas("p1o", new Textura("assets/graficos/bomberman1/personaje/2/oeste.png"));
		Engine.getInstancia().addTexturas("p1m", new Textura("assets/graficos/bomberman1/personaje/2/muerte.png"));
